...
// import { GuessTheNumber } from "../components/GuessTheNumber"; // Temporarily disabled due to contract binding issue
import { GuessTheNumberDemo } from "../components/GuessTheNumberDemo"; // Demo version without wallet requirement
